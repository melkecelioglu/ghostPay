...
const Profile: React.FC = () => {
  ...
  const handleEditClick = () => {
    router.push("/components/edit-profile");
  };

  const handlePaymentMethodClick = () => {
    router.push("/components/edit-payment-method");
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-slate-200 text-gray-800">
      ...
      <p className="text-lg text-gray-600 mb-8">
        Do you want to edit your profile? Or find an old playlist? Take a break
        from work? You can do it all here.
      </p>
      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-100 p-4 rounded-lg mb-4">
          ...
          <p>
            All premium benefits at a special price for college or university
            students.
          </p>
          <p>
      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-100 p-4 rounded-lg mb-4">
          <p>
            Your next invoice is for 14.99 TL and will be charged on 20.06.2023
            to your Mastercard ending in 123.
          </p>
          <p className="mt-2">
      ...
      <div className="flex justify-between">
        <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-6 rounded">
          <Link href="/components/change-plan">Change Plan</Link>
        </button>
        <button
          className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded"
          onClick={handlePaymentMethodClick}
        >
          <Link href="/components/edit-payment-method">
